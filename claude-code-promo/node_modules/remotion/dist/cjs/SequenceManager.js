...
exports.SequenceManagerProvider = exports.VisualModeSettersContext = exports.VisualModeDragOverridesContext = exports.VisualModeCodeValuesContext = exports.SequenceVisibilityToggleContext = exports.SequenceManager = void 0;
...
const SequenceManagerProvider = ({ children }) => {
    ...
    const getDragOverrides = (0, react_1.useCallback)((nodePath) => {
        var _a;
        return (_a = dragOverrides[nodePathToString(nodePath)]) !== null && _a !== void 0 ? _a : {};
    }, [dragOverrides]);
    const getCodeValues = (0, react_1.useCallback)((nodePath) => {
